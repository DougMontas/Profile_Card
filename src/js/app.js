...
function render(variables = {}) {
  ...
  const name = variables.name ? variables.name : "Enter name";
  const lastname = variables.lastname ? variables.lastname : "Enter lastname";
  const city = variables.city ? variables.city : "Enter city";
  const role = variables.role ? variables.role : "Enter role";
  const country = variables.country ? variables.country : "Enter country";
